...
const CustomerLedger = () => {
  ...
  const { allcustomerLedgerData, loading } = useSelector(
  ...
  const filteredCustomerLedger = allcustomerLedgerData?.filter(
    (customerLedger) =>
                      ...
                      <tbody>
                        {filteredCustomerLedger?.length === 0 ? (
                          <td
                            ...
                            style={{ color: "#10c2a7" }}
                          >
                            No Customer Ledger Details Found
                          </td>
                        ) : (
                          <>
                            {filteredCustomerLedger?.map(
                              (customerLedger, i) => (
                                <tr key={i}>
                                  <td
                                    className="text-center"
