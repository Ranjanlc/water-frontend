...
const AddVendorPayment = () => {
  ...
  const { allVendorPaymentData } = useSelector(
  ...
  const filteredVendorp = allVendorPaymentData?.filter((vendorpt) =>
    vendorpt.vendorName.toLowerCase().includes(searchTerm.toLowerCase())
  );
  //   const filteredVendorp = allVendorPaymentData?.filter((vendorpt) =>
  //   vendorpt.vendorName && vendorpt.vendorName.toLowerCase().includes(searchTerm.toLowerCase())
  // );

  console.log(allVendorPaymentData);
  return (
    <>
                  ...
                  >
                    ...
                    <tbody>
                      {filteredVendorp?.length === 0 ? (
                        ...
                        <>
                          {filteredVendorp?.map((ftvendor, i) => (
                            <tr key={i}>
                              <td
                                className="text-center"
                                style={{ paddingLeft: "4rem" }}
