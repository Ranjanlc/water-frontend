...
import { addProductPrice  , deleteProductPrice, getAllProductPrice } from '../../../../../Redux/Features/Customer/SetProductionPriceSlice';
...
const SetProductionPrice = () => {
  ...
  console.log(allProductPriceData)
        ...
        <div className='row'>
            ...
            <div className='row mt-3'>
              <div className="col-md-4">
                <div className="form-group">
                  ...
                  {productNameError && (
                    <div
                      className="d-flex gap-2 align-items-center" style={{ color: "red" }}><i class="fa-sharp fa-solid fa-circle-exclamation"></i>
                      {productNameError}
                    </div>
                  )}
                </div>
          ...
          <div className="col-md-4">
             ...
             <div className="d-grid gap-2 d-flex justify-content-center my-4">
              <button className="button" style={{ verticalAlign: "middle" }}  onClick={handleSubmitProduct}>
              Save
              </button>
            </div>
